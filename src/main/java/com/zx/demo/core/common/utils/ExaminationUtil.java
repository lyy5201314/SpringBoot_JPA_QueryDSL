package com.zx.demo.core.common.utils;

import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

public class ExaminationUtil {
    private static final Logger log = LoggerFactory.getLogger(ExaminationUtil.class);
    ...
    public static void end() {
        ...
        log.info("---------------您的代码执行时间为：" + time.substring(0, time.equals("0.0") ? 1 : (time.indexOf(".") + 3)) + " ms, 消耗内存：" + memory.substring(0, memory.equals("0.0") ? 1 : (memory.indexOf(".") + 3)) + " M + !---------------");
    }
